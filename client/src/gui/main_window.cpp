...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent)
{
    setWindowTitle("OmniFolder Client");
    resize(800, 600);
    ...
    navList->addItems({"Dashboard", "Folders", "Settings"});
    ...
    pages->addWidget(createFoldersPage());    // index 1
    pages->addWidget(createSettingsPage());   // index 2
