...
#ifndef OMNISERVER_MAILBOX_H
#define OMNISERVER_MAILBOX_H
...
public slots:
     ...
     */
    void onMessageReady(const Message& message, const QString& tempSocketId = QString());
