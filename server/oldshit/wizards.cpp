...
void Wizards::newNetworkWizard()
{
    ...
    std::string ghubServerPAT;
    std::string ghubClientPAT;
    ...
    OmniServer::initNewNetwork(name, ipaddress, port, username, password, ghubUsername, ghubServerPAT, ghubClientPAT);
...
void Wizards::recoverNetworkWizard()
{
    ...
    OmniServer::replaceDestroyedServerAndStart(ipaddress, port, username, password, ghubUsername, ghubServerPAT, ghubClientPAT);
